    ...
    <div class="content">
        ...
        <div class="register-agreement">
            ...
            <div class="agreement-list">
                <ul>
                    <li>ระบบลงทะเบียนประกอบด้วย 3 ส่วน ได้แก่ รหัสลงทะเบียน ข้อมูลนักศึกษา และรหัสผู้ใช้งาน</li>
                    <li>นักศึกษาต้องกรอกข้อมูลที่เป็นจริงและถูกต้องเพื่อใช้งานการตรวจสอบสิทธิ์การใช้งาน</li>
                    <li>นักศึกษาต้องกรอกข้อมูลให้ครบทุกช่องเพื่อผลประโยน์ของนักศึกษาในการใช้งานเว็บไซต์</li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="grid-container">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="student_email" class="form-control"
                                       value="" placeholder="ระบุที่อยู่อีเมล์">
